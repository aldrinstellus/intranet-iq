...
// Validate ../../../src/app/api/search/similar/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/search/similar">> = Specific
  const handler = {} as typeof import("../../../src/app/api/search/similar/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
